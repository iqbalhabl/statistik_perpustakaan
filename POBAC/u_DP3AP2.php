...
$checkQuery = "SELECT COUNT(*) as count FROM layanan_dp3ap2 WHERE tanggal = '$tanggal'";
...
if ($count > 0) {
    ...
    $updateQuery = "UPDATE layanan_dp3ap2 SET pelajarL='$pelajarL', pelajarP='$pelajarP', mhsL='$mhsL', mhsP='$mhsP', umumL='$umumL', umumP='$umumP' WHERE tanggal='$tanggal'";
