...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_ponpesibnul (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../PAKET/formPONPESIbnul.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>PONPES Ibnul Qoyyim</title>
</head>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Paket Buku PONPES Ibnul Qoyyim</h1>
