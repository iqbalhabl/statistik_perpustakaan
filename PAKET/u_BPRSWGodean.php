...
$checkQuery = "SELECT COUNT(*) as count FROM layanan_bprswgodean WHERE tanggal = '$tanggal'";
...
if ($count > 0) {
    ...
    $updateQuery = "UPDATE layanan_bprswgodean SET pelajarL='$pelajarL', pelajarP='$pelajarP', mhsL='$mhsL', mhsP='$mhsP', umumL='$umumL', umumP='$umumP' WHERE tanggal='$tanggal'";
