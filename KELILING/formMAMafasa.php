...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_mamafasa (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../KELILING/formMAMafasa.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Keliling MA Mafasa</h1>
