...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_sdtamanan3 (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../KELILING/formSDTamanan3.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SD Tamanan 3 Kalasan</title>
</head>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Keliling SD Tamanan 3 Kalasan</h1>
