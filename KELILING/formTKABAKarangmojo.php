...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_tkabakarangmojo (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../KELILING/formTKABAKarangmojo.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>TK ABA Karangmojo 1</title>
</head>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Keliling TK ABA Karangmojo 1</h1>
