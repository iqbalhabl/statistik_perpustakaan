...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_sdmuhconcat (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../KELILING/formSDMuhconcat.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SD Muhammadiyah Condong catur</title>
</head>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Keliling SD Muhammadiyah Condong catur</h1>
