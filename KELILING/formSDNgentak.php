...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_sdngentak (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../KELILING/formSDNgentak.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SD Ngentak Banguntapan</title>
</head>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan Keliling SD Ngentak Banguntapan</h1>
