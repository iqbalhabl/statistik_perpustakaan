...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_smpn1paliyan (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../SIF/formSMPN1Paliyan.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan SIF SMPN 1 Paliyan</h1>
