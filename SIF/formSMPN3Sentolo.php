...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO ruang_smpn3sentolo (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../SIF/formSMPN3Sentolo.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan SIF SMPN 3 Sentolo</h1>
