...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO layanan_sdmsleman (tanggal, pelajarL, pelajarP, mhsL, mhsP, umumL, umumP) VALUES ('$tanggal', '$pelajarL', '$pelajarP', '$mhsL', '$mhsP', '$umumL', '$umumP' )";
    ...
    $conn->close();
    header("Location: ../SIF/formSDMSLeman.php"); //ini posisi dimana
    exit();
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="form">
        <h1>Input Data Layanan SIF SD Model Sleman</h1>
